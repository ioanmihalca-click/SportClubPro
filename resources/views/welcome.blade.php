    ...
    <div class="flex flex-col items-center justify-center min-h-screen bg-gray-50 dark:bg-black">
        ...
        <main class="relative flex items-center flex-grow overflow-hidden">
            ...
            <div class="absolute inset-0 z-0 opacity-65">
                <div
                    class="absolute rounded-full left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[1200px] bg-gradient-radial from-teal-100 via-blue-50/50 to-transparent blur-2xl dark:from-teal-900/50 dark:via-blue-900/30 dark:to-transparent">
                </div>
                <div
                    class="absolute rounded-full left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-gradient-radial from-blue-50 via-teal-50/50 to-transparent blur-2xl dark:from-blue-900/50 dark:via-teal-900/30 dark:to-transparent">
                </div>
            </div>
                        ...
                        <div class="pt-4">
                            ...
                            <div class="flex flex-col gap-4 sm:flex-row">
                                ...
                                <button id="installApp" style="display: none;"
                                    class="inline-flex items-center px-6 py-3 font-semibold text-white transition-colors bg-blue-600 rounded-lg shadow-lg hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600">
