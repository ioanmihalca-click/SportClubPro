<footer class="relative w-full py-8 overflow-hidden bg-gradient-to-br from-gray-100 to-white dark:from-gray-900 dark:to-gray-800">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="relative z-10">
            <!-- Top section -->
            <div class="grid gap-8 mb-8 md:grid-cols-2 lg:grid-cols-3">
                <!-- Logo & Description -->
                <div class="space-y-4">
                    <img src="{{ asset('assets/logo.webp') }}" alt="SportClubPro Logo" 
                         class="w-auto h-10 transition-transform duration-300 transform hover:scale-105">
                    <p class="max-w-md text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                ...
                <!-- Quick Links -->
                <div class="space-y-3">
                    <h3 class="text-xs font-medium tracking-wider text-gray-900 uppercase dark:text-gray-100">
                        Link-uri Utile
                    </h3>
                    <ul class="space-y-2">
                        <li>
